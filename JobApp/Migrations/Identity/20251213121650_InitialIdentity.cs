        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobDetails_Employers_EmployerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AppliedJobsId = table.Column<int>(type: "INTEGER", nullable: false),
                    EmployeesId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeJobDetails", x => new { x.AppliedJobsId, x.EmployeesId });
                    table.ForeignKey(
                        name: "FK_EmployeeJobDetails_Employees_EmployeesId",
                        column: x => x.EmployeesId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeJobDetails_JobDetails_AppliedJobsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeJobDetails_EmployeesId",
                table: "EmployeeJobDetails",
                column: "EmployeesId");

            migrationBuilder.CreateIndex(
                name: "IX_JobDetails_EmployerId",
                table: "JobDetails",
                column: "EmployerId");
        }
